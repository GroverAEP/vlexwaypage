"""
Django settings for frBot project.
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # 👈 aquí va

]

ROOT_URLCONF = 'frBot.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "frontend.core.context_processors.user_session",  # 👈 tu processor
...
WSGI_APPLICATION = 'frBot.wsgi.application'
